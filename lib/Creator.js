...
class Creator {
  ...
  async create() {
    ...
    let branch = await this.getTagInfo1()
    // 下载模板
  ...
  async download(branch) {
    // 模板下载地址
    let templateUrl = `yutao721/h5-vue3-template`;
    if (branch == 'vue2') {
      templateUrl = `yutao721/vue-h5-template#vue2-h5-template`
    }
